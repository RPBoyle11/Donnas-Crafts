    ...
    return (
        <div className="App">
          ...
          <div className='about-me'>
            ...
            <p>Most items in the store are one of a kind, so if you see something you like, make sure you buy it right away!  If there is something that you LOVE, but it has already sold, please feel free to reach out to me.  I will let you know if its possible to make it again.</p>
          </div>
